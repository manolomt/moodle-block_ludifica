...
$string['dynamic_help-pointsbyendcourse'] = 'Gana <strong>{$a} puntos</strong> por culminar un curso.';
...
$string['dynamic_help-pointsbyendmodule'] = 'Obtén <strong>{$a} puntos </strong>por cada actividad que desarrolles en este curso.';
$string['dynamic_help-noactivities'] = 'No hay actividades que asignen puntos en este curso.';
$string['dynamic_help-pointsbymodule'] = '<strong>{$a} puntos.</strong>';
$string['edit'] = 'Editar';
...
$string['overcomelevel'] = 'para alcanzar el nivel <strong>{$a}</strong>.';
$string['owner'] = 'Dueño';
...
$string['pointslevel'] = 'Gana <strong>{$a} puntos</strong>';
