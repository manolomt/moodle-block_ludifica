...
$string['dynamic_help-pointsbyendcourseduration'] = 'Gana <strong>{$a}*X puntos</strong> al completar un curso, donde <strong>X</strong> es la duración recomendada del curso.';
