...
$string['dynamic_help-pointsbyendcourse'] = 'Gana <strong>{$a} puntos</strong> por completar un curso.';
$string['dynamic_help-pointsbyendcourseduration_site'] = 'Gana <strong>{$a}*X puntos</strong> al completar un curso, donde <strong>X</strong> es la duración recomendada del curso.';
$string['dynamic_help-pointsbyendcourseduration'] = 'Gana <strong>{$a->totalpoints} puntos</strong> al completar este curso, donde <strong>{$a->courseduration} X</strong> es la duración recomendada del curso.';
