...
$string['dynamichelps'] = 'Pestaña Puntos adicionales';
...
$string['dynamic_help_title'] = 'Obtén puntos adicionales por los siguientes criterios:';
$string['dynamic_help-pointsbyendcourse'] = 'Gana {$a} puntos por culminar un curso.';
$string['dynamic_help-recurrentlogindays'] = 'Ingresa {$a} días para iniciar una racha ';
$string['dynamic_help-pointsrecurrentlogin'] = 'y gana {$a} puntos.';
$string['dynamic_help-pointsbyday'] = '¡Cuida tu racha! después de que inicies una, ganarás {$a} puntos cada día.';
$string['dynamic_help-pointstocoins'] = 'Cada que consigas {$a} puntos se te otorgarán ';
$string['dynamic_help-coinsbypoints'] = '{$a} monedas.';
$string['dynamic_help-pointsbyendmodule'] = 'Obtén {$a} puntos por cada actividad que desarrolles en este curso.';
...
$string['helptitle_pointsbycoursemodule'] = 'Este curso da puntos por los siguientes criterios:';
...
$string['maxlevel'] = 'El nivel máximo que puedes alcanzar es {$a}';
...
$string['overcomelevel'] = 'para superar el nivel {$a}.';
$string['owner'] = 'Dueño';
...
$string['pointslevel'] = 'Gana {$a} puntos';
...
$string['tabtitle_dynamichelps'] = 'Puntos adicionales';
