...
$string['dynamic_help-pointsbyendcourseduration'] = 'Earn <strong>{$a->totalpoints} points</strong> by completing a course, be <strong>{$a->courseduration} X</strong> the recommended duration of the course.';
