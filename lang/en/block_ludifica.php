...
$string['dynamichelps'] = 'Tab Additional points';
...
$string['dynamic_help_title'] = 'Obtain extra points for the following items:';
$string['dynamic_help-pointsbyendcourse'] = 'Earn {$a} points by completing a course.';
$string['dynamic_help-recurrentlogindays'] = 'Login {$a} days to begin a streak ';
$string['dynamic_help-pointsrecurrentlogin'] = 'and earn {$a} points.';
$string['dynamic_help-pointsbyday'] = 'After you start a streak, you will earn {$a} points every day.';
$string['dynamic_help-pointstocoins'] = 'Each time you earn {$a} points you will be awarded ';
$string['dynamic_help-coinsbypoints'] = '{$a} coins.';
$string['dynamic_help-pointsbyendmodule'] = 'Earn {$a} points for each activity you complete in this course.';
...
$string['helptitle_pointsbycoursemodule'] = 'This course gives points for the following items:';
...
$string['maxlevel'] = 'The highest level you can reach is {$a}';
...
$string['overcomelevel'] = 'to overcome the level {$a}.';
$string['owner'] = 'Owner';
...
$string['pointslevel'] = 'Get {$a} points';
...
$string['tabtitle_dynamichelps'] = 'Additional points';
