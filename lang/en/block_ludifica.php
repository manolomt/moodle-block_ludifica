...
$string['dynamic_help-pointsbyendmodule'] = 'Earn <strong>{$a} points </strong>for each activity you complete in this course.';
$string['dynamic_help-noactivities'] = 'There are no activities that give points in this course.';
$string['dynamic_help-pointsbymodule'] = '<strong>{$a} points.</strong>';
$string['edit'] = 'Edit';
...
$string['overcomelevel'] = 'to reach the level<strong> {$a}.</strong>';
$string['owner'] = 'Owner';
...
$string['pointslevel'] = 'Get<strong> {$a} points</strong>';
